...
Kubernetes operator that deploys split host/remote controllers in Gardener environments, rendering a Helm chart or kustomize source per operator and applying each half to its target cluster via server-side apply.
