...
# Spec: Equivalence Comparator

## Purpose

Defines the comparison logic in `internal/equivalence` that asserts the operator's rendered+transformed output is semantically equivalent to the golden render for a given operator fixture.
