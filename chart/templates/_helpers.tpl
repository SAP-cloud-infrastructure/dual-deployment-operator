...
*/}}
{{- define "dual-deployment-operator.name" -}}
...
*/}}
{{- define "dual-deployment-operator.fullname" -}}
...
*/}}
{{- define "dual-deployment-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "dual-deployment-operator.resourceName" -}}
{{- $fullname := include "dual-deployment-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "dual-deployment-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "dual-deployment-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
