...
- **Gardener egress labels** (`values.yaml` `manager.pod.labels`): `networking.gardener.cloud/to-dns`, `to-public-networks`, `to-private-networks: allowed` — required for pod egress under the seed's deny-all NetworkPolicy.
